...
![1 (4).jpg](https://image.lceda.cn/oshwhub/pullImage/4c2ca33e662e4f08a99c28bb9df3de5b.jpg)
## 写在前面
硬件已经迭代了几次，目前结构比较稳定，应该不会再大改了。软件这边我会在空闲时间继续加功能、修 bug，最新程序可以看[aystmjz/Smart-Wake-Up-Light](https://github.com/aystmjz/Smart-Wake-Up-Light)。现在唤醒灯的核心功能基本都实现了，我自己也用了几个月，体验还不错。因为最近在忙保研，有些新点子还没时间实现，等空下来会慢慢更新。项目的教程也比较详细，推荐有兴趣的朋友动手二次开发，欢迎加入交流群377956571一起玩！
## 视频链接
有时间了更新
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/767aa890f4564c7d91425fb7d2e1646b.png)

![image.png](https://image.lceda.cn/oshwhub/pullImage/c795f5cc20e241538be7572d8ad6b643.png)

![image.png](https://image.lceda.cn/oshwhub/pullImage/b26f9bb087fc42c9919185a0e81af61c.png)

![image.png](https://image.lceda.cn/oshwhub/pullImage/27dc5bfa588b4bdabd53b0f744440306.png)
## 显示介绍
主界面

![image.png](https://image.lceda.cn/oshwhub/pullImage/5d510fb17c4242ee8324800a4e34a78d.png)
设置菜单界面

![image.png](https://image.lceda.cn/oshwhub/pullImage/14fa243955f94362a7d8272305c97f78.png)
设置时间界面

![image.png](https://image.lceda.cn/oshwhub/pullImage/89d701822e0b4c2895829864ab4d9663.png)
设置闹钟界面


![image.png](https://image.lceda.cn/oshwhub/pullImage/0085028afbb443b599567ff710ad3ea4.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/c053f6b07d144203abc074f50540ac3f.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/5299c260e17949a28f524698e90b292c.png)
## 外壳
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/2170e51cacea4825aee1af6bf33b9486.png)
## 装配指南
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/b4871f95857a49c9b5c749f588b598c3.png)

![image.png](https://image.lceda.cn/oshwhub/pullImage/b144f4d8e89445ccb5bd24bbc864cd17.png)
## 烧录指南
最新的烧录文件可在[aystmjz/Smart-Wake-Up-Light/releases](https://github.com/aystmjz/Smart-Wake-Up-Light/releases/)下载
1. 连接烧录夹，如下图：
![image.png](https://image.lceda.cn/oshwhub/pullImage/49079c9e98e04e8bb4adedb335e78a20.png)
3. 设置蓝牙模块，将sys.h中的 DEBUG_MODE 宏定义为 4，编译烧录单片机，连接调试接口的RX和TX，发送以下AT 指令：
- 将波特率设置为 115200 bps：`AT+BAUD 7`
- 设置设备名称：`AT+NAME Smart WakeUpLight`
（以上为手动设置蓝牙模块，仅需设置一次，有时间了会更新代码，自动设置蓝牙模块）
5. 将sys.h中的 DEBUG_MODE 宏定义为 0，编译烧录单片机。
6. 烧录ASRPRO，USB连接电脑，关闭语音助手常开模式，使用附件中的烧录工具下载，出现等待连接提示后连续按下两次按键供电即开始烧录（或者开启语音助手常开模式，按下复位按钮）

# 设计原理
## 硬件介绍

![实物图讲解.jpg](https://image.lceda.cn/oshwhub/pullImage/2232aecd24aa4e4faad2a68ecbcf8d7c.jpg)
- 主控：stm32f103c8t6
...
![电气连接框图.jpg](https://image.lceda.cn/oshwhub/pullImage/d750e2b4d75a4cdebc1d7d4ec35e4b33.jpg)
系统支持两种输入电源：
- DC电源输入（如外接适配器或电源模块）
- USB电源输入（来自电脑或移动电源）
...
![数据流向框图.jpg](https://image.lceda.cn/oshwhub/pullImage/31a98f00c60d4b89b732e00944f5a651.jpg)
- 核心控制器：STM32F103C8T6
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/c7b89e9cc29a4c5ebc5d31fe2307b2aa.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/f309ed195634408595cae047578bb81b.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/b91c423504504c769554a2d427aa0073.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/28c81a480d7e4f13bac286267155dee3.png)
## ASRPRO烧录
1. USB连接电脑
2. 关闭语音助手常开模式
3. 天问Block编译下载
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/32f24a839a184214b7da3268736f12cb.png)
...
![image.png](https://image.lceda.cn/oshwhub/pullImage/46247ef6d5b448d28c5302d5fecbe7cc.png)

![image.png](https://image.lceda.cn/oshwhub/pullImage/0cd1b8eda1e54ad0afbd491adbeb6248.png)
在对应的OLED_Data_Hanzi.c文件中添加数据。
调用OLED_Printf函数显示，示例：
`OLED_Printf(132, 30, OLED_8X16, BLACK, "设置");`


![image.png](https://image.lceda.cn/oshwhub/pullImage/be2ac1d12fc9486b8fe6d0e9fbce104a.png)
